    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="mb-8 text-center max-w-2xl mx-auto">
                <div className="bg-brand-orange p-3 rounded-full inline-block mb-4">
                    <Bot className="h-10 w-10 text-brand-orange" />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                {/* Form Section */}
                <div className="lg:col-span-4 bg-white p-6 md:p-8 rounded-2xl shadow-xl border border-brand-orange/50 relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-brand-orange to-indigo-500"></div>
                    <form onSubmit={handleGenerate} className="space-y-5">
                        ...
                        <button type="submit" disabled={isGenerating} className="btn-primary w-full mt-6 py-3 flex items-center justify-center gap-2 group relative overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-brand-orange transform scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300"></div>
                        </button>
                    </form>
                </div>
                ...
                <div className="lg:col-span-8 bg-slate-900 rounded-2xl shadow-xl min-h-[500px] border border-slate-700 flex flex-col relative overflow-hidden">
                    {/* Decorative lights */}
                    <div className="absolute -top-40 -right-40 w-80 h-80 bg-brand-orange rounded-full blur-[100px] opacity-20 pointer-events-none"></div>
                        ...
                        {!generatedPlan && !isGenerating ? (
                            ...
                            <div className="h-full flex flex-col items-center justify-center space-y-6">
                                <div className="relative">
                                    <div className="absolute inset-0 rounded-full border-t-2 border-brand-orange animate-[spin_1s_linear_infinite] w-16 h-16 blur-[2px]"></div>
                                    <div className="rounded-full border-t-2 border-brand-orange animate-spin w-16 h-16"></div>
                                </div>
                                <p className="text-brand-orange animate-pulse font-medium text-lg tracking-wide">AI is composing your structured plan...</p>
                            </div>
                        ) : (
